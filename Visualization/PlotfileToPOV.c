...
void MFPlotfileToPOV(FILE*,char*,MFErrorHandler);
...
void MFPlotfileToPOV(FILE *fid,char *name, MFErrorHandler e)
 {
  static char RoutineName[]={"PlotfileToPOV"};
  int mV,iV,iV0;
