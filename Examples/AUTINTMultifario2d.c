...
static char *id="@(#) $Id: AUTINTMultifario2d.c,v 1.3 2011/07/21 17:43:45 mhender Exp $";
...
/* AUTINTMultifario, int - Braatu's equation with boundary condition and integral constraint */
...
int main(int argc,char *argv[])
 {
  ...
  MFAUTOBVSetRealParameter(M,"ds0",0.5,e);

  MFAUTOBVSetRealParameter(M,"epsl",1.e-7,e);
  MFAUTOBVSetRealParameter(M,"epsu",1.e-7,e);
  MFAUTOBVSetIntegerParameter(M,"iid",2,e);
...
/*MFAUTOAddUserZero(M,0,1.,e);
  ...
  MFMultifarioSetFilename(H,"AUTINTMultifario2d",e);
