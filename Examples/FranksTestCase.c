...
int main(int argc, char *argv[])
 {
  ...
  MFMultifarioSetRealParameter(H,"epsilon",.0005,e);            /* Max distance from TS to M */
  ...
  MFMultifarioSetIntegerParameter(H,"page",1,e);             /* Page out interior polyhedra */
  ...
  MFMultifarioSetFilename(H,"Franks",e);
